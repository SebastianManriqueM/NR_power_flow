%  <CÁLCULO DO FLUXO DE POTÊNCIA - LOAD FLOW APPLYING ALTERN-DECOUPLED METHOD V1.0. 
...
%Cálculo_Fluxo_de_Potência_Desacoplado_Alternado
...
tol        = 0.0005;
disp('Inicio Cálculo Fluxo Desacoplado Alternado');
disp(datestr(now));
...
%=================================
imprimir_res( index_original, num_barras, num_n_novos, num_linhas, nodo_i, nodo_j, P_calc, Q_calc, v_barras, delt_barras, S_ij, Perdas_ij, I_ij, P_base, V_base, cont, nome_sis, '2-2da',Dados_linhas_or, Dados_barras_or, num_n_PQ )
